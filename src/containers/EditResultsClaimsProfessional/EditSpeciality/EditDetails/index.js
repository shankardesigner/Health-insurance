...
function EditDetails({
	...
	const handleSliderChange = (event, value, name) => {
		setModalState({
			...modalState,
			[name]: { ...modalState[name], value: value },
		});
	};
						...
						<Table className={classes.table} aria-label="simple table">
							...
							<TableBody>
								...
								<TableRow>
									...
									{/* <ModalTableCell align={'left'} className={modalClasses.tableRightBorder}>
                                        <CurrencyComponent>{paidPerService}</CurrencyComponent>
                                    </ModalTableCell>
                                    <ModalTableCell align={'left'} className={modalClasses.tableRightBorder}>
								...
								<TableRow>
									...
									{/* <ModalTableCell align={'left'} className={modalClasses.tableRightBorder}>
                                        <CurrencyComponent>{paidPerServiceBenchmark}</CurrencyComponent>
                                    </ModalTableCell>
                                    <ModalTableCell align={'left'} className={modalClasses.tableRightBorder}>
                                        ...
                                        >
                                            ...
                                            <Grid item xs={12}>
                                                <Input
                                                    ...
                                                    classes={{ root: clsx(modalClasses.inputStyle, modalClasses.inputPadding) }}
                                                    margin="dense"
                                            ...
                                            <Grid item xs={12}>
                                                <div className={modalClasses.sliderRoot}>
                                                    <PrettoSlider
                                                        onChange={(e, newValue) => handleSliderChange(e, newValue, 'nemoPaidPerService')}
                                                        value={Number(sliderState.nemoPaidPerService.value)}
                                            ...
                                            <Grid item xs={12}>
                                                <div className={modalClasses.sliderRoot}>
                                                    <PrettoSlider
                                                        ...
                                                        onChange={(e, newValue) => handleSliderChange(e, newValue, 'nemoUnitsPerK')}
                                                        getAriaValueText={valuetext}
                                                        aria-labelledby="discrete-slider-always"
                                                        step={0.01}
                                                        marks={marks}
										...
										>
											...
											<Grid item xs={12}>
												<Box
													component="div"
													visibility="hidden"
													className={modalClasses.sliderRoot}
												>
													<PrettoSlider
														defaultValue={1.0}
														onChange={() => {}}
								...
								<TableRow>
									...
									{/* <ModalTableCell align={'left'} className={clsx(modalClasses.tableRightBorder, modalClasses.tableBottomBorder)}>
                                        <CurrencyComponent>{results.paidPerService.value}</CurrencyComponent>
                                    </ModalTableCell>
                                    <ModalTableCell align={'left'} className={clsx(modalClasses.tableRightBorder, modalClasses.tableBottomBorder)}>
